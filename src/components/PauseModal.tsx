  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-[280px] sm:max-w-[320px] max-h-[96%] overflow-y-auto bg-[#1a1a1a] border-2 sm:border-4 border-[#606060] rounded p-2 sm:p-4 shadow-[0_0_30px_rgba(0,0,0,0.95)] text-white font-pixel flex flex-col items-center"
      >
        {/* Title */}
        <div className="flex flex-col items-center mb-1.5 sm:mb-3">
          <span className="text-[#f8b800] text-base sm:text-xl tracking-[0.25em] font-bold animate-pulse drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
            PAUSE
          </span>
          {isOnlineGuest && (
            <span className="text-[7.5px] sm:text-[9px] text-zinc-400 font-mono tracking-widest mt-0.5">
              ONLINE MATCH (GUEST)
            </span>
          )}
        </div>
        ...
        {/* Menu Body */}
        {!showConfirmQuit ? (
          <div className="w-full flex flex-col gap-1.5 sm:gap-2.5 mb-1.5 sm:mb-3">
            {/* RESUME Option */}
            <button
              id="pause-btn-resume"
              type="button"
              ...
              className={`w-full py-1.5 sm:py-2.5 px-3 sm:px-4 rounded border-2 flex items-center justify-between transition-all cursor-pointer ${
                selectedIdx === 0
          ...
          <div className="w-full flex flex-col items-center bg-[#222] border-2 border-red-800/80 rounded p-2 sm:p-3 mb-1.5 sm:mb-3 animate-in zoom-in-95 duration-100">
            <div className="flex items-center gap-1.5 text-red-400 font-bold text-[9.5px] sm:text-xs tracking-wider mb-1">
              <AlertTriangle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 shrink-0" />
              <span>QUIT TO MENU?</span>
            </div>
            <p className="text-[8px] sm:text-[9px] text-zinc-400 text-center mb-2 sm:mb-3 leading-relaxed font-sans">
            ...
            <div className="w-full grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className={`py-1.5 sm:py-2 px-2.5 sm:px-3 rounded border-2 text-center text-[9.5px] sm:text-xs tracking-wider font-bold transition-all cursor-pointer ${
                  confirmIdx === 0
        ...
        <div className="w-full pt-1.5 sm:pt-2.5 border-t border-[#383838] flex flex-col items-center gap-0.5 sm:gap-1 text-[7.5px] sm:text-[9px] text-zinc-400 font-mono tracking-wider">
          {!showConfirmQuit ? (
            <>
